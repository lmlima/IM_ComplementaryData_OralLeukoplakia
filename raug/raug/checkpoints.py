...
def load_model (checkpoint_path, model, opt_fn=None, loss_fn=None, epoch=None, load_backbone_only=False):
    """
    ...
    if load_backbone_only:
        ckpt['model_state_dict'] = {k: ckpt['model_state_dict'][k] for k in ckpt['model_state_dict'] if k.startswith("features.")}
